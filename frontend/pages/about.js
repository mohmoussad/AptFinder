    ...
    <>
      ...
      <div style={{ margin: "40px" }}>
        ...
        <p>
          ...
          proident, sunt in culpa qui officia deserunt mollit anim id est laborum." Section 1.10.32 of "de Finibus
          Bonorum et Malorum", written by Cicero in 45 BC "Sed ut perspiciatis unde omnis iste natus error sit
          ...
          qui dolorem eum fugiat quo voluptas nulla pariatur?" 1914 translation by H. Rackham "But I must explain to you
          how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete
          account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder
          of human happiness.
        </p>
        <img width="100%" src="/team.jpg" alt="" />
        <h5>No one rejects, dislikes, or avoids pleasure itself</h5>
        <p>
          ...
          pleasure?" Section 1.10.33 of "de Finibus Bonorum et Malorum", written by Cicero in 45 BC "At vero eos et
          ...
          molestiae non recusandae. Ita          pains."
        </p>
      </div>
    </>
  );
